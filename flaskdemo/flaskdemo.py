...
@app.route('/about')
def about():
    return "This is a sample Flask and Wikipedia API" + ("https://www.iconfinder.com/icons/1023542/"
                    "conical_flask erlenmeyer_flask_lab_equipments_lab_flask_volumetric_flask_icon")
